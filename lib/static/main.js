...
if (!settings) {
    localStorage.setItem('settings', JSON.stringify({
        'breathSpeed': 10,
        'cycleDelay': 1,
        'cycleFirstColor': '#ff0000',
        'cycleSecondColor': '#0000ff',
        'lotteryDelay': 1,
        'lotteryMainColor': '#ff0000',
        'lotteryBallsColor': '#0000ff',
        'tornadoSaturation': 255,
        'tornadoValue': 10,
        'tornadoDelay': 10,
        'tornadoGap': 36358,
        'tornadoSpeed': 4885,
...
function updateSettings() {
    ...
    localStorage.setItem('settings', JSON.stringify({
        ...
        'cycleFirstColor': el('first-color'),
        'cycleSecondColor': el('second-color'),
        'lotteryDelay': el('lottery-delay'),
        'lotteryMainColor': el('main'),
        'lotteryBallsColor': el('balls'),
        'tornadoSaturation': el('sat'),
        'tornadoValue': el('val'),
        'tornadoDelay': el('delay'),
        'tornadoGap': el('gap'),
        'tornadoSpeed': el('cycle-speed'),
    }))
}
