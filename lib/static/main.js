...
function updateSettings() {
    ...
    localStorage.setItem('settings', JSON.stringify({
        'breathSpeed': el('breath-speed'),
        'cycleDelay': el('cycle-delay'),
        'cycleFirstColor': el('cycle-first-color'),
        'cycleSecondColor': el('cycle-second-color'),
        'lotteryDelay': el('lottery-delay'),
        'lotteryMainColor': el('lottery-main-color'),
        'lotteryBallsColor': el('lottery-balls-color'),
        'tornadoSaturation': el('tornado-saturation'),
        'tornadoValue': el('tornado-value'),
        'tornadoDelay': el('tornado-delay'),
        'tornadoGap': el('tornado-gap'),
        'tornadoSpeed': el('tornado-speed'),
    }))
}
